    ...
    >
      <div className="px-4 py-4 flex flex-col gap-3">
        ...
        <div
          ...
          style={{ borderBottom: '1px solid var(--plat-400)', paddingBottom: 10 }}
        >
        ...
        <Field label="Bio">
          Coder, storyteller, explorer of ideas — stitching together software,
          stories, systems, and curiosity. Currently building things that matter.
        </Field>
